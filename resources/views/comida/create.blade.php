...
<div class="card-body table-border-style">
    <form method="POST" action="{{route('comida.store')}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nombreComida') is-invalid @enderror" id="nombreComida" name="nombreComida">
            @error('nombreComida')
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('precio') is-invalid @enderror" id="precio" name="precio" step="0.01">
            @error('precio')
            <span class="invalid-feedback" role="alert">
                <strong>{{$message}}</strong>
            </span>
